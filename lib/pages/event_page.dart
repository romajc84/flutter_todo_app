...
final List<Event> _eventList = [
  Event('08:00', 'Have coffee with Same', 'Personal', true),
  Event('10:00', 'Meet with Sales.', 'Work', true),
  Event('12:00', 'Call Tom about appointment', 'Work', false),
  Event('14:00', 'Fix on boarding experience', 'Work', false),
  Event('16:00', 'Edit API documentation', 'Personal', false),
  Event('18:00', 'Set up user focus group.', 'Personal', false),
];
...
class IconLine extends BoxPainter {
  ...
  void paint(Canvas canvas, Offset offset, ImageConfiguration configuration) {
    ...
    final Offset centerBottom = configuration.size
        .centerLeft(Offset(leftOffset.dx, leftOffset.dy + iconSpace));
    final Offset end =
        configuration.size.topLeft(Offset(leftOffset.dx, leftOffset.dy * 3));
